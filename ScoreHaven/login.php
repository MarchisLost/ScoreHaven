	    	    ...
	    	    <ul class="navbar-nav mr-auto">
	    	      ...
	    	      <li class="nav-item dropdown">
	    	    	...
	    	    	<div>
						...
						<a href="#myModal" class="btn btn-outline-success trigger-btn" data-toggle="modal">Sign in</a>
	    		    </div>
	    	  </div>
	    </div>
	</nav>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="dados.php" method="post">
						...
						<div class="form-group">
							<button name="submit" type="submit" class="btn btn-primary btn-block btn-lg">Sign In</button>
						</div>
...
<?php  
    ...
    if(isset($_POST["submit"])){
        ...
        $select_sql="select password from alunos where nome= '$name'";
        ...
        if($pwi == $passw){ 
          $sel_sql="select numaluno, nome, idade from alunos where nome= '$name'";
          $info= mysqli_query($ligacao, $sel_sql);
          $data= mysqli_fetch_assoc($info);
          
          $_SESSION["nome"]=$data['nome'];
          $_SESSION["idade"]=$data['idade'];
          $_SESSION["numaluno"]=$data['numaluno'];
